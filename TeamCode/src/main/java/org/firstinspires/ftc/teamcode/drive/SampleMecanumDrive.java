...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        leftRear = hardwareMap.get(DcMotorEx.class, HardwareConstants.ID_LEFT_REAR_MOTOR);
        rightRear = hardwareMap.get(DcMotorEx.class, HardwareConstants.ID_RIGHT_REAR_MOTOR);
