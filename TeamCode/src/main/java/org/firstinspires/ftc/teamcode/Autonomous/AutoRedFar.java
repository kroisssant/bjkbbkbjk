...
public class AutoRedFar extends CommandOpModeAuto {
    ...
    public void initialize() {
        ...
        scoringSubsystem.setPivot(Constants.PIVOT_SUS - 0.6);
        ...
        BackboardToStackGuide = drive.trajectorySequenceBuilder(BackboardToStackCenter1.end())
                .lineToLinearHeading(new Pose2d(-60.4, -3, Math.toRadians(180)))
                .build();
...
//tura 3
        ...
        BackboardToStackGuide2 = drive.trajectorySequenceBuilder(BackboardToStackCenter12.end())
                .lineToLinearHeading(new Pose2d(-61, -4, Math.toRadians(180)))
                .build();
         ...
         autoCenter = new SequentialCommandGroup(
                ...
                new SequentialCommandGroup(
                        new SequentialCommandGroup(
                                ...
                                new WaitCommand(300),
                                new InstantCommand(() -> scoringSubsystem.setBratPos(0.04)),
                                new InstantCommand(() -> glisiereSubsystem.setGlisiereFinalPosition(250)),
                                new InstantCommand(() -> intakeSubsystem.end()),
                                new InstantCommand(() -> intakeSubsystem.runRvs()),
                 ...
                 new InstantCommand(() -> glisiereSubsystem.setGlisiereFinalPosition(1000)),

                new SequentialCommandGroup(
                        new ToScoreCommand(1000,Constants.PIVOT_SUS - 0.15,  0, scoringSubsystem, glisiereSubsystem),
                ...
                new SequentialCommandGroup(
                 ...
                 new InstantCommand(()->intakeSubsystem.setDropdown(0.16)),
        ...
        new SequentialCommandGroup(
                         ...
                         new ParallelCommandGroup(
                             new SequentialCommandGroup(
                                     ...
                                     new InstantCommand(() ->scoringSubsystem.setBratPos(0.06)),
                                     new InstantCommand(() -> glisiereSubsystem.setGlisiereFinalPosition(250)),
                                     new InstantCommand(() -> intakeSubsystem.end()),
        ...
        new SequentialCommandGroup(
                ...
                new SequentialCommandGroup(
                        ...
                        new InstantCommand(()-> intakeSubsystem.setDropdown(0.11)),
                        new InstantCommand(() -> intakeSubsystem.runFwd()),
                        new InstantCommand(() -> {
                            glisiereSubsystem.setGlisiereFinalPosition(50);
                            scoringSubsystem.setBratPos(0.04);
                ...
                new SequentialCommandGroup(
                        ...
                        new InstantCommand(()->intakeSubsystem.setDropdown(0.3))
                ),
                new InstantCommand(() -> intakeSubsystem.runFwd()),
...
//                                new WaitCommand(200),
        ...
        //caz right
         autoRight = new SequentialCommandGroup(
                ...
                new ParallelCommandGroup(
                        new ToScoreCommand(Constants.GLISIERA_UP, Constants.PIVOT_SUS-0.5, 0, scoringSubsystem, glisiereSubsystem),
