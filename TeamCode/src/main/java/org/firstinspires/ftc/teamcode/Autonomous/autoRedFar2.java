...
@Autonomous
public class autoRedFar2 extends CommandOpModeAuto {
    ...
    public void initialize() {
        ...
        BackboardToStackGuide = drive.trajectorySequenceBuilder(BackboardToStackCenter1.end())
                .lineToLinearHeading(new Pose2d(-60.5, -3, Math.toRadians(180)))
                .build();
...
//                                new WaitCommand(300),
                ...
                new SequentialCommandGroup(
                        ...
                        new InstantCommand(() ->scoringSubsystem.setBratPos(0.05)),
                        new InstantCommand(() -> glisiereSubsystem.setGlisiereFinalPosition(250)),
                        new InstantCommand(() -> intakeSubsystem.dropdownUp()),
                        new WaitCommand(150),
                        new InstantCommand(() -> intakeSubsystem.end()),
...
//                                new WaitCommand(200),
                        ...
                        new ParallelCommandGroup(
                                new InstantCommand(() -> scoringSubsystem.setBratPos(0.07)),
