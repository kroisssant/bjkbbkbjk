...
@Autonomous
public class AutoRedFarSplineTest extends CommandOpModeAuto {
    ...
    private TrajectorySequence SplineStackToBackboardLeft;
    private TrajectorySequence SplineStackToBackboardCenter;
    private TrajectorySequence SplineStackToBackboardCenter2;
    private TrajectorySequence SplineStackToBackboardCenter3;
    private TrajectorySequence SplineStackToBackboardRight;

    private TrajectorySequence SplineBackboardLeftToStack;
    private TrajectorySequence SplineBackboardCenterToStack;
    private TrajectorySequence SplineBackboardCenterToStack2;
    private TrajectorySequence SplineBackboardCenterToStack3;
    private TrajectorySequence SplineBackboardRightToStack;
...
//tura 3
        ...
        SplineStackToBackboardLeft = drive.trajectorySequenceBuilder(MovCentruMoveToStack.end())
        ...
        SplineStackToBackboardRight = drive.trajectorySequenceBuilder(MovCentruMoveToStack.end())
                .setTangent(Math.toRadians(0))
                .splineToConstantHeading(new Vector2d(0, -8), Math.toRadians(0))
        ...
        SplineBackboardLeftToStack = drive.trajectorySequenceBuilder(SplineStackToBackboardLeft.end())
        ...
        SplineBackboardRightToStack = drive.trajectorySequenceBuilder(SplineStackToBackboardLeft.end())
                .setTangent(Math.toRadians(180))
                .splineToConstantHeading(new Vector2d(0, -8), Math.toRadians(180))
                .splineToConstantHeading(new Vector2d(-60, -12), Math.toRadians(180))
                .build();
...
//                                new WaitCommand(100),
                ...
                new ParallelCommandGroup(
                        new RoadRunnerCommand(drive, SplineStackToBackboardCenter),
                        new SequentialCommandGroup(
                                new WaitCommand(600),
                ...
                new ParallelCommandGroup(
                        new RoadRunnerCommand(drive, SplineBackboardCenterToStack),
...
//                                }),
                ...
                new ParallelCommandGroup(
                        ...
                        new RoadRunnerCommand(drive, SplineStackToBackboardCenter2)
                ),
                ...
                new ParallelCommandGroup(
                        new RoadRunnerCommand(drive, SplineBackboardCenterToStack3),
                        new InstantCommand(() -> {
                            scoringSubsystem.setPressureDreaptaPos(Constants.PRESSURE_DREAPTA_INCHIS);
                            scoringSubsystem.setPressureStangaPos(Constants.PRESSURE_STANGA_INCHIS);
                            scoringSubsystem.setBratPos(0.07);
...
//                new RoadRunnerCommand(drive, BackboardToStackGuide2),
                ...
                new ParallelCommandGroup(
                        ...
                        new RoadRunnerCommand(drive, SplineStackToBackboardCenter3),
